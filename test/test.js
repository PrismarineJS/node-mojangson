...
describe('mojangson', function () {
  const data = [
    ...
    ['{key:value,}', { type: 'compound', value: { key: { value: 'value', type: 'string' } } }],
    ['[0:v1,1:v2]', { type: 'list', value: [{ value: 'v1', type: 'string' }, { value: 'v2', type: 'string' }] }],
    ['[0:"§6Last Killed: None",1:"§6Last Killer: None",2:"§6Rank: §aNovice-III",3:"§6§6Elo Rating: 1000",]', { type: 'list', value: [{ value: '§6Last Killed: None', type: 'string' }, { value: '§6Last Killer: None', type: 'string' }, { value: '§6Rank: §aNovice-III', type: 'string' }, { value: '§6§6Elo Rating: 1000', type: 'string' }] }],
    ['{id:1s,Damage:0s,Count:1b,tag:{display:{Name:"§r§6Class: Civilian",Lore:[0:"§6Last Killed: None",1:"§6Last Killer: None",2:"§6Rank: §aNovice-III",3:"§6§6Elo Rating: 1000",],},},}', { type: 'compound', value: { id: { value: 1, type: 'short' }, Damage: { value: 0, type: 'short' }, Count: { value: 1, type: 'byte' }, tag: { type: 'compound', value: { display: { type: 'compound', value: { Name: { value: '§r§6Class: Civilian', type: 'string' }, Lore: { type: 'list', value: [{ value: '§6Last Killed: None', type: 'string' }, { value: '§6Last Killer: None', type: 'string' }, { value: '§6Rank: §aNovice-III', type: 'string' }, { value: '§6§6Elo Rating: 1000', type: 'string' }] } } } } } } }],
    ['[1,2,3]', { type: 'list', value: [{ value: 1, type: 'int' }, { value: 2, type: 'int' }, { value: 3, type: 'int' }] }],
    ['[1,2,3,]', { type: 'list', value: [{ value: 1, type: 'int' }, { value: 2, type: 'int' }, { value: 3, type: 'int' }] }],
    ['[]', []],
